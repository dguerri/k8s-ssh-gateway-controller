...
func (r *TLSRouteReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	var k8sRoute gatewayv1alpha2.TLSRoute
...
func (r *TLSRouteReconciler) handleAddOrUpdate(ctx context.Context, req ctrl.Request, k8sRoute *gatewayv1alpha2.TLSRoute, routeDetails *routeDetails) (ctrl.Result, error) {
	// Add or Update.
...
func (r *TLSRouteReconciler) handleDeletion(ctx context.Context, req ctrl.Request, k8sRoute *gatewayv1alpha2.TLSRoute, routeDetails *routeDetails) (ctrl.Result, error) {
	// Handle deletion
